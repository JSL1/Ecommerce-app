...
import ccIcon from '../images/shopping.png';
        ...
        <section id="checkout-forms">
            ...
            <div id="payment">
                    <div id="payment-paypal">
                        <div><img src={paypalIcon} alt="Paypal" /></div>
                        <div>
                            <input type="radio" name="pay-option" id="paypal-option" />
                            <label htmlFor="paypal-option">Pay with Paypal</label>
                        </div>
                    </div>
                    <div id="payment-mastercard">
                        <div><img src={ccIcon} alt="Visa/Mastercard" /></div>
                        <div>
                            <span><input type="radio" name="pay-option" />Pay with Credit Card</span>
                        </div>
                    </div>
                </div>
            ...
            <div id="same-address">
               ...
               <br /><br />
                ...
                <form id="checkout-shipping" onSubmit={handleSubmit}>
                {!sameAsBilling && (
                    <>
                        <label htmlFor="fullname"><span className="material-symbols-outlined">person</span>Full Name:</label>
                            <input type="text" name="fullname" id="fullname" minLength={2}  required />
